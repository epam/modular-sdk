...
class ApplicationType(str, Enum):
    ...
    CUSTODIAN = 'CUSTODIAN'
    CUSTODIAN_LICENSES = 'CUSTODIAN_LICENSES'
    CUSTODIAN_DEFECT_DOJO = 'CUSTODIAN_DEFECT_DOJO'
    CUSTODIAN_RABBITMQ = 'CUSTODIAN_RABBITMQ'
    RIGHTSIZER = 'RIGHTSIZER'
    RIGHTSIZER_LICENSES = 'RIGHTSIZER_LICENSES'
    RIGHTSIZER_DEFECT_DOJO = 'RIGHTSIZER_DEFECT_DOJO'
    RIGHTSIZER_RABBITMQ = 'RIGHTSIZER_RABBITMQ'
    RABBITMQ = 'RABBITMQ'
    DEFECT_DOJO = 'DEFECT_DOJO'
    K8S_KUBE_CONFIG = 'K8S_KUBE_CONFIG'
    GCP_CHRONICLE_INSTANCE = 'GCP_CHRONICLE_INSTANCE'
    SEP_SANDBOX_AWS = 'SEP_SANDBOX_AWS'
    SEP_SANDBOX_AZURE = 'SEP_SANDBOX_AZURE'
    SEP_LICENSES = 'SEP_LICENSES'
    SANDBOX_PROVISIONING_DATA = 'SANDBOX_PROVISIONING_DATA'
